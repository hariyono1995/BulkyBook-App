...
namespace FinalBulkyBookWeb.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Details(int orderId)
        {
            OrderVM orderVM = new()
            {
                OrderHeader = _unityOfWork.OrderHeader.GetFirstOrDefault(u => u.Id == orderId, includeProperties: "ApplicationUser"),
                OrderDetail = _unityOfWork.OrderDetail.GetAll(u => u.OrderId == orderId, includeProperties: "Product")
            };
            return View(orderVM);
        }
        ...
        {
            OrderVM.OrderHeader = _unityOfWork.OrderHeader.GetFirstOrDefault(u => u.Id == OrderVM.OrderHeader.Id, includeProperties: "ApplicationUser");
            OrderVM.OrderDetail = _unityOfWork.OrderDetail.GetAll(u => u.OrderId == OrderVM.OrderHeader.Id, includeProperties: "Product");
        ...
        {
            OrderHeader orderHeader = _unityOfWork.OrderHeader.GetFirstOrDefault(u => u.Id == orderHeaderId);
            ...
            if (orderHeader.PaymentStatus == SD.PaymentStatusDelayedPayment)
            {
                ...
                {
                    _unityOfWork.OrderHeader.UpdateStripePaymentID(orderHeaderId, orderHeader.SessionId, session.PaymentIntentId);
        ...
        {
            OrderHeader orderHeaderFromDb = _unityOfWork.OrderHeader.GetFirstOrDefault(u => u.Id == OrderVM.OrderHeader.Id, tracked:false);
        ...
        {
            OrderHeader orderHeader = _unityOfWork.OrderHeader.GetFirstOrDefault(u => u.Id == OrderVM.OrderHeader.Id, tracked:false);
            ...
            _unityOfWork.Save();
            TempData["success"] = "Order Shipped Update Successfully.";
            return RedirectToAction(nameof(Details), "Order", new { orderId = OrderVM.OrderHeader.Id });
        }
        ...
        public IActionResult GetAll(string status)
        {
            ...
            else
            {
                ...
                orderHeaders = _unityOfWork.OrderHeader.GetAll(u => u.ApplicationUserId == claim.Value, includeProperties: "ApplicationUser");
            }
